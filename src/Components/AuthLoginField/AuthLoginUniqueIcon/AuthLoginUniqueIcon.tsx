...
const AuthLoginUnique: React.FC<Props> = ({ type }: Props) =>
  type ? (
    <>
    ...
    <>
      ...
      >
        <path
          d="M205.21,0C92.057,0,0,92.057,0,205.21s92.057,205.21,205.21,205.21s205.21-92.057,205.21-205.21S318.364,0,205.21,0z
